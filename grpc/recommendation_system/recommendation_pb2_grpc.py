...
class ShowRecommendationStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetRecommendations = channel.unary_unary(
                '/recommendation.ShowRecommendation/GetRecommendations',
...
class ShowRecommendationServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_ShowRecommendationServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'recommendation.ShowRecommendation', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('recommendation.ShowRecommendation', rpc_method_handlers)
